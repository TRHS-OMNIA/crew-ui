...
<template>
    <div>
        <label>
            ...
            <input type="text" :class ="{'invalid': !valid, 'center': center}" :placeholder="placeholder" :inputmode="inputmode" :value="modelValue" @input="$emit('update:modelValue', $event.target.value)" @focusin="focus = true" @focusout="focus = false"/>
        </label>
    </div>
</template>
